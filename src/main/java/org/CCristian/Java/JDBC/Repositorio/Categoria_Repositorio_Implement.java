...
public class Categoria_Repositorio_Implement implements Repositorio<Categoria> {
    private Connection conn;

    public Categoria_Repositorio_Implement(Connection conn) {
        this.conn = conn;
    }

    public Categoria_Repositorio_Implement() {
    }
